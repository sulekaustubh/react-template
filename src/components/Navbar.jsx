...
const Navbar = () => {
	...
	return (
		<>
			<header className="flex tracking-widest text-gray-100 text-xl space-x-8 justify-center sticky top-0 p-4 bg-[#222222] shadow-sm items-center">
				<div className="">
				...
				<ul className="hidden md:flex gap-4 uppercase font-medium">
					{authState.isLoggedIn ? (
						<>
							<li className="bg-blue-500 text-white hover:bg-blue-600 duration-300 font-medium rounded-2xl">
								<Link
									to="/tasks/add"
						...
						<li className="py-2 px-3 cursor-pointer text-primary transition rounded-sm">
